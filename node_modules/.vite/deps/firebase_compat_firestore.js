import {
  ...
  yh,
  zf
} from "./chunk-GYXO7FB2.js";
import {
  firebase
} from "./chunk-DL2EQKDN.js";
import {
  Component,
  getModularInstance
} from "./chunk-BUF5J6QJ.js";
...
var Blob = class {
  ...
  static fromBase64String(base64) {
    ...
    return new Blob(Uh.fromBase64String(base64));
  }
  static fromUint8Array(array) {
    assertUint8ArrayAvailable();
    return new Blob(Uh.fromUint8Array(array));
  }
  toBase64() {
    assertBase64Available();
...
var QueryDocumentSnapshot = class extends DocumentSnapshot {
  data(options) {
    ...
    B(data !== void 0, "Document in a QueryDocumentSnapshot should exist");
    return data;
  }
};
var Query = class {
